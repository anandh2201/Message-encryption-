...
public class AES_Encryption {
    // static String plainText = "This is a plain text which need to be encrypted by
    // AES Algorithm with CBC Mode";
//    static Scanner myObj = new Scanner(System.in); // Create a Scanner object
//   // static System.out.println("enter the test");
//    static String plainText = myObj.nextLine();
